...
export function UpdateBanner() {
  // Стартуем сразу в 'checking' (initial state), а не через setState в
  // эффекте — иначе react-hooks/set-state-in-effect ловит синхронный
  // setState на маунте. Рендерит null, пока идёт проверка.
